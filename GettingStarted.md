...
If you are not using the Sailfish&nbsp;OS OBS yet, you shall obtain an account there by following the instructions at [the Sailfish&nbsp;OS OBS front page](https://build.sailfishos.org/).
