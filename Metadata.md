...
| Categories:                      | List of categories in which the package will be displayed  | Each category shall be provided in a single line prefixed by `- ` (dash & space).  Defaults to `Other`.  See [freedesktop.org:AppStream-docs:ct-categories](https://www.freedesktop.org/software/appstream/docs/chap-CatalogData.html#tag-ct-categories) for the general specification.  Valid main categories are `Library` and those listed in [freedesktop.org:menu-spec:apa](https://specifications.freedesktop.org/menu-spec/latest/apa.html), additional categories are listed in [freedesktop.org:menu-spec:apas02](https://specifications.freedesktop.org/menu-spec/latest/apas02.html) (plus [freedesktop.org:menu-spec:apas03](https://specifications.freedesktop.org/menu-spec/latest/apas03.html) when really appropriate). |
