...
| &nbsp;&nbsp;DescriptionMD: | URL for package description in MarkDown format      | If given, description from specified URL is loaded and rendered as a MarkDown text ([syntax](https://github.com/showdownjs/showdown/wiki/Showdown's-Markdown-syntax)). |
