...
| &nbsp;&nbsp;DescriptionMD: | URL for a package description in MarkDown                  | If provided, a description is downloaded from specified URL and rendered as MarkDown (see [Showdown's-Markdown-syntax](https://github.com/showdownjs/showdown/wiki/Showdown's-Markdown-syntax)). |
